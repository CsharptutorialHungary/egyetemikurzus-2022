namespace Inventory
{
    ...
    internal class KeyItem : ItemType
    {
    ...
    internal class MultiplayerItem : ItemType
    {
    ...
    internal class Consumable : ItemType
    {
    ...
    internal class Ammunition : ItemType
    {
    ...
    internal class BossSoul : ItemType
    {
